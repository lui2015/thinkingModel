    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-8">
        ...
        <div className="flex items-center bg-surface-alt rounded-lg p-0.5">
          <button onClick={() => setViewMode("grid")} className={`p-1.5 rounded-md transition-colors ${viewMode === "grid" ? "bg-surface-solid shadow-sm text-primary" : "text-text-light"}`}>
          ...
          <button onClick={() => setViewMode("list")} className={`p-1.5 rounded-md transition-colors ${viewMode === "list" ? "bg-surface-solid shadow-sm text-primary" : "text-text-light"}`}>
