...
export default function Footer() {
  return (
    <footer className="bg-surface-solid border-t border-border mt-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/models" className="text-text-secondary hover:text-primary transition-colors">模型库</Link></li>
              <li><Link href="/graph" className="text-text-secondary hover:text-primary transition-colors">模型图谱</Link></li>
            </ul>
          </div>
          <div>
